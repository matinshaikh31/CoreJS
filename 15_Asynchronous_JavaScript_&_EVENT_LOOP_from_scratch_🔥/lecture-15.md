...
* Browser has JS Engine which has Call Stack which has Global execution context, local execution context etc.
  ...
  * Now JS needs some way to connect the callstack with all these superpowers. This is done using Web APIs.
  ![Event Loop 1 Demo](/Images/eventloop1.jpg)

### WebAPIs
None of the below are part of Javascript! These are extra superpowers that browser has. Browser gives access to JS callstack to use these powers.
![Event Loop 2 Demo](/Images/eventloop2.jpg)
...
* Let's undertand the below code image and its explaination:
    ![Event Loop 3 Demo](/Images/eventloop3.jpg)
    * ```js
      console.log("start");
...
```
![Event Loop 6 Demo](/Images/eventloop6.jpg)
Microtask Priority Visualization
![Event Loop 7 Demo](/Images/microtask.gif)
...
![microtask 1 Demo](/Images/microtask1.gif)
![microtask 2 Demo](/Images/microtask2.gif)
![microtask 3 Demo](/Images/microtask3.gif)
![microtask 4 Demo](/Images/microtask4.gif)
![microtask 5 Demo](/Images/microtask5.gif)
![microtask 6 Demo](/Images/microtask6.gif)
